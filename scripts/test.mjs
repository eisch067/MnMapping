...
function testCountyImagerySummary() {
  ...
  assert.deepEqual(restrictedImageryForCounty("Anoka").map((source) => source.year), [2026, 2025, 2024, 2020, 2017]);
  ...
  assert.deepEqual(restrictedImageryForCounty("Dakota").map((source) => source.year), [2025, 2025]);
  assert.deepEqual(restrictedImageryForCounty("Dodge").map((source) => source.year), [2026]);
  ...
  assert.deepEqual(restrictedImageryForCounty("Goodhue").map((source) => source.year), [2025]);
  assert.deepEqual(restrictedImageryForCounty("Grant").map((source) => source.year), [2017]);
  ...
  assert.deepEqual(restrictedImageryForCounty("Mille Lacs").map((source) => source.year), [2026]);
  assert.deepEqual(restrictedImageryForCounty("Morrison").map((source) => source.year), [2020]);
  assert.deepEqual(restrictedImageryForCounty("Mower").map((source) => source.year), [2023]);
  ...
  assert.deepEqual(restrictedImageryForCounty("Otter Tail").map((source) => source.year), [2024]);
  assert.deepEqual(restrictedImageryForCounty("Pennington").map((source) => source.year), [2023]);
  assert.deepEqual(restrictedImageryForCounty("Pipestone").map((source) => source.year), [2020]);
  assert.deepEqual(restrictedImageryForCounty("Polk").map((source) => source.year), [2025]);
  assert.deepEqual(restrictedImageryForCounty("Pope").map((source) => source.year), [2023]);
  assert.deepEqual(restrictedImageryForCounty("Redwood").map((source) => source.year), [2016]);
  assert.deepEqual(restrictedImageryForCounty("Renville").map((source) => source.year), [2024]);
  assert.deepEqual(restrictedImageryForCounty("Scott").map((source) => source.year), [2026]);
  assert.deepEqual(restrictedImageryForCounty("Sherburne").map((source) => source.year), [2024]);
  ...
  assert.deepEqual(restrictedImageryForCounty("Stearns").map((source) => source.year), [2024]);
  assert.deepEqual(restrictedImageryForCounty("Steele").map((source) => source.year), [2025]);
  assert.deepEqual(restrictedImageryForCounty("Swift").map((source) => source.year), [2024]);
  assert.deepEqual(restrictedImageryForCounty("Traverse").map((source) => source.year), [2022]);
  assert.deepEqual(restrictedImageryForCounty("Washington").map((source) => source.year), [2026]);
  assert.deepEqual(restrictedImageryForCounty("Wright").map((source) => source.year), [2025]);
  assert.deepEqual(restrictedImageryForCounty("Yellow Medicine").map((source) => source.year), [2025]);
...
function testImageryResearchTracker() {
  ...
  assert.equal(records.find((record) => record.county === "Clay")?.other[0]?.detail, "Approximately 6-inch imagery");
  ...
  assert.equal(records.find((record) => record.county === "Mille Lacs")?.other[0]?.year, "2026");
  assert.equal(records.find((record) => record.county === "Nobles")?.other[0]?.detail, "3-inch county imagery");
  assert.equal(records.find((record) => record.county === "Washington")?.other[0]?.year, "2026");
  assert.equal(records.find((record) => record.county === "Yellow Medicine")?.other[0]?.year, "2025");
  ...
  assert.deepEqual(anoka.other.map((source) => source.year), ["2026", "2025", "2024", "2020", "2017"]);
