...
The September 18 ArcGIS REST audit added anonymous county imagery services for Big Stone, Blue Earth, Carver, Chippewa, Dakota, Dodge, Goodhue, Mower, Pipestone, Scott, Steele, Stevens, and Yellow Medicine. Cached Web Mercator services use tiles; county-coordinate-system and uncached services use dynamic export, while Dakota's raster services use ImageServer export. Stevens' public 2020 Pictometry MapServer is integrated; its official 2026 and 2023 commercial WMTS mosaics are linked externally because no third-party embedding grant was found.
