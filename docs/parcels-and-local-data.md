...
The South expansion adds 25 counties through the statewide adapter plus direct official services for Meeker, Dodge, and Goodhue. Across Minnesota, 64 counties currently expose repeatable parcel layers and 23 remain pending. The full South decision record is in [`south-region-status.md`](south-region-status.md).
