...
export const imageryResearchLeads: readonly ImageryResearchLead[] = [
  lead("Freeborn", "Freeborn County Beacon", "https://beacon.schneidercorp.com/Application.aspx?AppID=333&LayerID=3784", "Official property viewer; the public 2020 Hollandale tile cache covers only part of the county, and no dated countywide service was found."),
  ...
  lead("Isanti", "Isanti County GIS viewer", "https://experience.arcgis.com/experience/afa4f0f2b20e4a11814c824a9a85f6c5", "Official viewer uses Nearmap's most-current imagery, whose acquisition date varies by location; a separate public 2020 cache is only partial coverage."),
  ...
  lead("Lac qui Parle", "Lac qui Parle County Pictometry fee record", "https://www.lqpco.com/DocumentCenter/View/758/2026-Fee-Schedule", "The 2026 fee schedule confirms a paid Pictometry Online subscription but does not identify the imagery acquisition year."),
  ...
  lead("Lincoln", "Lincoln County GIS viewer", "https://lcmn.maps.arcgis.com/apps/webappviewer/index.html?id=bd3d7b6cc3814818ab38a32c4b8c7105", "Official county viewer currently references Esri World Imagery rather than a dated county imagery service."),
