...
const specs: readonly ArcGisImagerySpec[] = [
  ...
  map("grant", "2024-eagleview", "2024 Grant County EagleView", 2024, "grant-imagery/Grant/EagleView2024/MapServer", "https://gis.co.grant.mn.us/arcgis/rest/services/Grant/EagleView2024/MapServer", "Not published", "Official county aerial mosaic."),
  map("grant", "2021-pictometry", "2021 Grant County Pictometry", 2021, "grant-imagery/Grant/Pictometry2021/MapServer", "https://gis.co.grant.mn.us/arcgis/rest/services/Grant/Pictometry2021/MapServer", "Not published", "Official county aerial mosaic."),
