...
const southCountyInputs: readonly SouthCountyInput[] = [
  ...
  { id: "lac-qui-parle", name: "Lac qui Parle", fips: "073", batch: "S2", bounds: bounds(-96.4530, 44.8048, -95.7366, 45.2694), imagery: ["south11", "south11ir"], additionalLayers: isPersonalMode ? [
  ...
  ] : undefined, parcelCount: 8_876, parcelAcquired: "2025-12-10" },
  { id: "meeker", name: "Meeker", fips: "093", batch: "S2", bounds: bounds(-94.7635, 44.8919, -94.2556, 45.3266), imagery: ["meek13"], parcelLayer: isPersonalMode
    ? directParcel("meeker", "Meeker", bounds(-94.7635, 44.8919, -94.2556, 45.3266), "/api/gis-proxy/meeker-open/Parcels_hub/FeatureServer", "https://services2.arcgis.com/pHb2Lre5eSy5plfE/arcgis/rest/services/Parcels_hub/FeatureServer/0", 0, "PID", { parcelId: "PID", owner: "NAME", mailingAddress: "MAILING", acres: "DEED_AC", legalDescription: "LEGAL1" })
    : directParcel("meeker", "Meeker", bounds(-94.7635, 44.8919, -94.2556, 45.3266), "/api/gis-proxy/meeker-open/Parcels_hub/FeatureServer", "https://services2.arcgis.com/pHb2Lre5eSy5plfE/arcgis/rest/services/Parcels_hub/FeatureServer/0", 0, "PID", { parcelId: "PID", acres: "DEED_AC", legalDescription: "LEGAL1" }, "Official public county parcel geometry (shape and boundary only). Owner name and mailing address exist on the source service but are intentionally not requested by MnMapping pending county confirmation — see docs/licensing/COUNTY-DETAILS/meeker.md.", "https://www.meekercountymn.gov/539/GIS"), additionalLayers: isPersonalMode ? [createMeekerImageryLayer(2024), createMeekerImageryLayer(2018)] : undefined },
  ...
  { id: "lincoln", name: "Lincoln", fips: "081", batch: "S3", bounds: bounds(-96.4528, 44.1967, -96.0785, 44.6313), imagery: ["south11", "south11ir"], additionalLayers: isPersonalMode ? [
